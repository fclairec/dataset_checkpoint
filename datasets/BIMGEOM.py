...
class BIM(InMemoryDataset):
    ...
    urls = {
        'T1': 'https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi%3A10.7910%2FDVN%2FYK86XK&version=DRAFT#',
        ...
        'T4': 'https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi%3A10.7910%2FDVN%2FYK86XK&version=DRAFT#'
